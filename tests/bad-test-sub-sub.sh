...
$DataNow board write --app testApp --board testBoard 1
$DataNow board write --app testApp --board testBoard 2
$DataNow board write --app testApp --board testBoard 3

$DataNow board read --app testApp --board testBoard
